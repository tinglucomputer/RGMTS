...
void compare_results(struct result *results_1, struct result *results_2, int top_1, int top_2, double *test_all, double *test_hit, double *privacy, double *test_all_o, double *test_hit_o, double *privacy_o, int **documents_temp);
